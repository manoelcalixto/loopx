...
includes(dashboardSource, "First-screen decision frame", "first-screen decision frame label");
includes(dashboardSource, "Waiting on", "first-screen waiting owner label");
includes(dashboardSource, "Recommended action", "first-screen recommended action label");
includes(dashboardSource, "Safety boundary", "first-screen safety boundary label");
includes(dashboardSource, "First user Todo", "first-screen first user todo label");
includes(dashboardSource, "Top Agent Todo", "first-screen top agent todo label");
includes(dashboardSource, "Todo projection gap", "first-screen todo projection gap label");
includes(dashboardSource, "Top 4 Todos with status", "share top-four todo label");
includes(dashboardSource, "Done", "share todo done status");
includes(dashboardSource, "Decision rebase required", "share decision freshness warning");
includes(dashboardSource, "this is not a repository rollback", "share decision non-rollback copy");
includes(dashboardSource, "Synthetic only", "showcase synthetic-only boundary");
includes(dashboardSource, 'Single-surface change', "delivery scale label");
includes(dashboardSource, 'Blocker report', "blocker label");
includes(dashboardSource, 'Quota guard', "quota guard label");
includes(dashboardSource, 'State writeback', "state writeback label");
...
includes(dashboardSource, "copy read-only command for", "agent management read-only command label");
