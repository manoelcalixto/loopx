...
for (const [snippet, label] of [
  ...
  ["Control-plane event ledger", "event ledger title"],
  ["The chat thread is not the source of truth", "source-of-truth copy"],
  ["eventClassLabel", "event class label map"],
  ["Accounting", "accounting label"],
  ["Human decisions", "decision label"],
  ["Evidence observations", "evidence label"],
  ["State refreshes", "state label"],
  ["Material progress", "work label"],
  ...
  ["neither chat threads nor installer logs are the source of truth", "promotion source-of-truth copy"],
  ["Decision freshness", "decision freshness panel title"],
  ["exact replay remains in append-only run history", "exact replay source-of-truth copy"],
  ["No checkpointed decisions in the current sample require rebasing", "empty decision freshness copy"],
  ["Decision rebase required", "decision rebase warning title"],
  ["this is not a repository rollback", "non-rollback copy"],
